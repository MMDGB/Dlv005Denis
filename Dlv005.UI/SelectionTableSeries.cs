...
namespace Dlv005.UI
{
    internal class SelectionTableSeries : ITable
    {
        /// <summary>
        /// The text box
        /// </summary>
        ...
        /// The m instance
        /// </summary>
        private static SelectionTableSeries mInstance;
        ...
        private SelectionTableSeries()
        {
            MessageBox.Show("Already exists");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTableSeries"/> class.
        /// </summary>
        /// <param name="textBox">The text box.</param>
        /// <param name="sourceTable">The source table.</param>
        private SelectionTableSeries(TextBox textBox, DataTable sourceTable, SelectionType type)
        {
        ...
        {
            row[selectionType.InsertionID] = values[0].Value;
            row[selectionType.InsertionText] = values[0].Key;

            // row["SeriesNumber"] = values[0].Value;
            // row["SeriesText"] = values[0].Key;
        ...
        public static SelectionTableSeries Create(TextBox textBox, DataTable sourceTable, SelectionType type)
        {
            return (mInstance == null) ? mInstance = new SelectionTableSeries(textBox, sourceTable, type) : null;
        }
    }
}